...
export const TermsAndConditions = () => {
    return (<div>
        ...
        <p>Welcome to Venti!</p>

        <p>These terms and conditions outline the rules and regulations for the use of Venti's Website, located at https://venti.app.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Venti if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>We implement a variety of security measures to maintain the safety of your personal information and your business/financial information. We offer the use of a secure server. All supplied sensitive information is transmitted via Secure Socket Layer (SSL) technology. It is only to be accessible by those authorised with special access rights to such systems, and are required to keep the information confidential.</p>
        ...
        <p>We employ the use of cookies. By accessing Venti, you agreed to use cookies in agreement with the Venti's Privacy Policy.</p>
