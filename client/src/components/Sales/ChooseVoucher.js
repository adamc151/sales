...
import styles from "./ChooseVoucher.module.css";
...
const itemTypes = [
    { name: "GOS1", link: "/add-gos1", icon: <MdLocalHospital /> },
    { name: "GOS3", link: "/add-gos3", icon: <MdLocalHospital /> }
];
